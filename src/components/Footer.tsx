export default function Footer() {
  ...
  return (
    <footer className="bg-foreground/[0.02] border-t border-foreground/10 py-12 px-6">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="md:col-span-2">
              <div className="mb-4">
                <h3 className="text-2xl font-bold text-primary mb-2">Vision Vault</h3>
              ...
              <div className="flex gap-4 mt-6">
                <a
                  href="#"
                  className="w-10 h-10 bg-foreground/5 hover:bg-primary/10 rounded-lg flex items-center justify-center transition-colors group"
                  aria-label="GitHub"
                >
                ...
                <a
                  ...
                  aria-label="Email"
                >
                  <svg className="w-5 h-5 text-foreground/70 group-hover:text-primary transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="mt-12 pt-8 border-t border-foreground/10">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <div className="text-foreground/70 text-sm">
                © {currentYear} Vision Vault. All rights reserved.
              </div>
              
              <div className="flex gap-6 text-sm">
                <a href="/privacy" className="text-foreground/70 hover:text-primary transition-colors">
                  Privacy Policy
                </a>
                <a href="/terms" className="text-foreground/70 hover:text-primary transition-colors">
                  Terms of Service
                </a>
                <a href="/sitemap" className="text-foreground/70 hover:text-primary transition-colors">
                  Sitemap
                </a>
              </div>
            </div>
